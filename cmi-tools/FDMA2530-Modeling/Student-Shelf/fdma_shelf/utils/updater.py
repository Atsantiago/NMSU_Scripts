"""
FDMA 2530 Shelf Update System v2.0.2
=====================================
...
def _get_current_version():
    """Get current version for display purposes."""
    try:
        manifest = _get_releases_manifest()
        return manifest.get("current_version", "2.0.1")
    except:
...
def run_update():
    ...
    try:
        ...
        if _is_newer(tag):
            ...
            _show_viewport_message(f"You are on the latest version of CMI Tools: {current_version}")
    except Exception as e:
