"""
CMI Rendering Checklist - Prof-Tools Maya Python Script
A comprehensive checklist tool for validating 3D models and renders in Maya for professors
...
Original student version from CMI Tools FDMA 2530 package
Adapted for Prof-Tools by Alexander T. Santiago - github.com/atsantiago
"""
...
# Package version
__package_version__ = get_prof_tools_version()

# Script information
SCRIPT_NAME = "CMI Rendering Checklist"
SCRIPT_VERSION = __tool_version__
PACKAGE_VERSION = __package_version__
PYTHON_VERSION = sys.version_info.major

# Create comprehensive title for UI with better visual separation
WINDOW_TITLE = f"{SCRIPT_NAME}: {SCRIPT_VERSION}  ——  Prof Tools: {PACKAGE_VERSION}"
...
# Checklist Items - Sequential numbering with new items (identical to CMI-tools version)
CHECKLIST_ITEMS = {
    1: ["Scene Units", "cm"],
...
def checklist_refresh():
    ...
    try:
        ...
        check_camera_aspect_ratio()  # Item 18 - Now enabled
...
def checklist_generate_report():
    ...
    try:
        ...
        report_strings.append(check_camera_aspect_ratio())  # Item 18 - Now enabled
    ...
    try:
        ...
        if (len(turntable_objects) == 1 and 
            ...
            cmds.button(
                "status_" + item_id,
                e=True,
                bgc=light_green_color,  # Changed from warning_color to light_green_color
                l='',
